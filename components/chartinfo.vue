    ...
    <v-card class="ma-0 text-justify">
        <v-card-text class="ma-0 pa-2">
            ...
            <v-alert title="Chart Interaction" variant="tonal" density="compact" border="start" class="mb-2">
                <p class="mb-2">You can hover your cursor over or click on any point on the chart. A tooltip will appear in the top-right corner, providing a brief summary. You will also see an updated <strong class="text-secondary">chart</strong> visualising the development of the total founds. The summary and <strong class="text-secondary">chart</strong> are corresponding to the current selected year on the horizontal axis.</p> 
